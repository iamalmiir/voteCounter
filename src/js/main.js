...
$(document).ready(function () {
    const articulateRequirementsDeveloping = $("#articulateRequirementsDeveloping");
    const articulateRequirementsAccomplished = $("#articulateRequirementsAccomplished");
    const chooseAppropriateToolsDeveloping = $("#chooseAppropriateToolsDeveloping");
    const chooseAppropriateToolsAccomplished = $("#chooseAppropriateToolsAccomplished");
    const giveClearAndCoherentOralPresentationDeveloping = $("#giveClearAndCoherentOralPresentationDeveloping");
    const giveClearAndCoherentOralPresentationAccomplished = $("#giveClearAndCoherentOralPresentationAccomplished");
    const functionedWellAsATeamDeveloping = $("#functionedWellAsATeamDeveloping");
    const functionedWellAsATeamAccomplished = $("#functionedWellAsATeamAccomplished");
    ...
    // If both inputs are empty, both inputs should be enabled
    // If one of the inputs contains a value, the other input will be disabled
    disableInput(articulateRequirementsDeveloping, articulateRequirementsAccomplished);
    disableInput(chooseAppropriateToolsDeveloping, chooseAppropriateToolsAccomplished);
    disableInput(giveClearAndCoherentOralPresentationDeveloping, giveClearAndCoherentOralPresentationAccomplished);
    disableInput(functionedWellAsATeamDeveloping, functionedWellAsATeamAccomplished);
